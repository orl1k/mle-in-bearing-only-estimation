...
observer = Ship('наблюдатель', observer_x, observer_y, observer_course,
                observer_velocity)  # создаем корабль-наблюдатель
...
print(np.mean(tma.bearings_with_noise))
...
# tests.add_result(result)
# tests.save_results()
# popt = tma.lm_algorithm([1, 1, 1, 1])
# tma.plot_algorithm_comparsion()
# print(tma.predicted_params[0])
